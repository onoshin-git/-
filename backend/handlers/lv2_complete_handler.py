"""POST /lv2/complete - Lv2完了レコード保存ハンドラ"""
...
def _update_progress(dynamodb, session_id: str, final_passed: bool, updated_at: str, lv1_session_id: str = None):
    ...
    # Get existing record to preserve lv1_passed
    ...
    if lv1_session_id is not None:
        ...
        table.put_item(Item={
            ...
            "lv2_passed": final_passed,
            "lv3_passed": lv1_existing.get("lv3_passed", False),
...
def handler(event, context):
    """Lambda handler for POST /lv2/complete."""
    try:
